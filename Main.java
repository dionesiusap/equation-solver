    ...
    public static void main(String[] args) {
        ...
        // Hilbert Matrix
            ...
            if (inp==1){
                ...
                hilbertMatrix = new HilbertMatrix(n);
                hilbertMatrix.fillMatrix();

                // solve the hilbert matrix
            }
            else{
                System.out.print("\nWhat is the name of your file? ");
                String filename = read.nextLine();
                ReadFile readhilbertfile = new ReadFile();
                readhilbertfile.readHilbertNFrom(filename, o);

                hilbertMatrix = new HilbertMatrix(o);
                hilbertMatrix.fillMatrix();                
            }

            Matrix hilbMatrix = new Matrix(hilbertMatrix.getMatrix(), hilbertMatrix.getListOfVariable());/*SECOND TERM NOT YET DEFINED*/
            matrix.gaussianElimination();
        }
        ...
        // Interpolation
            ...
            interpolation = new Interpolation(p);
            ...
            Matrix interpolatematrix = new Matrix(interpolatematrix.toMatrix(), interpolatematrix.getListOfVariable());/*SECOND TERM NOT YET DEFINED*/
